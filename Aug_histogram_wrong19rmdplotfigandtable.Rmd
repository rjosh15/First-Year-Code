...
colnames(df_filter_map_change_25)[9] <- "change_25"
colnames(df_filter_map_change_40_100)[9] <- "change_40100"
colnames(df_filter_map_change_25_40)[9] <- "change_2540"
colnames(df_filter_map_change_100_800)[9] <- "change_100"
...
library(plyr)
y <- join_all(list (race_eth_data_1,df2540), by='countyid', type='left')
z <- join_all(list (y,df40100), by='countyid', type='left')
y1 <- join_all(list (z,df25), by='countyid', type='left')
z1 <- join_all(list (y1,df100), by='countyid', type='left')
data_map_join_bbd <- z1
------------------------------- Regression-----------------------------------
regress_tab_bbd <- felm(amountofloan ~ change_25+change_2540+change_40100+change_100 |year, data= z1)

   stargazer(regress_tab10,title="Regression Results",single.row= TRUE, align=TRUE,type="text", out="new broadband.txt")
summary(z1)
...
plot_usmap(data = df_filter_map_change_100_800, values = "change_100") + scale_fill_continuous(
    low = "green", high = "magenta",
