 ...
 *******************************************************************************************  
   ...
   ---------------------------------------------------
   regress_tab10 <- felm(Original_UPB~ ratio |countyid+year, data= final_race_eth_data)
  ...
  regress_tab11 <- felm(Original_UPB~ ratio+Credit_Score+Original_DTI_Ratio |year+countyid, data= final_race_eth_data)
   ...
   stargazer(regress_tab10,regress_tab11,title="Univariate(1), multivariate(2)",single.row= TRUE,covariate.labels = c("Broadband Penetration"),omit.stat=c("ser"), align=TRUE,type="text", out="newtab loan amount compare.txt")
...
nrow(df_respondent_county)
  ...
  stargazer(regress_res_tab5,title=" Regression lending agencies vs internet penetration",single.row= TRUE, align=TRUE,type="text",covariate.labels = c("Broadband Penetration"),omit.stat=c("ser"), out="regtab5.txt")
...
---------------------------------------------------------------------------------------------
head(df_all_diff_med)#### Divide Fico by 100
