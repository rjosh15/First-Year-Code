...
title="Descriptive statistics County level Table 2",digits=1, out="New_table2.txt")
```
...
nrow(df_filter_map_change_25_40)
head(df_filter_map_change_100_800)
colnames(df_filter_map_change_25)[9] <- "Change25"
colnames(df_filter_map_change_40_100)[9] <- "Change40-100"
colnames(df_filter_map_change_25_40)[9] <- "Change25_40"
colnames(df_filter_map_change_100_800)[9] <- "Change100"
write.csv(df_filter_map_change_25,"df_filter_map_change_25.csv")
write.csv(df_filter_map_change_40_100,"df_filter_map_change_40_100.csv")
write.csv(df_filter_map_change_25_40,"df_filter_map_change_25_40.csv")
write.csv(df_filter_map_change_100_800,"df_filter_map_change_100_800.csv")
head(df_all_numeric)
--------------------------------Join change_bbd with df all num------------------

df_join1 <- sqldf("select * from df_all_numeric a left join df_filter_map_change_25 b on a.countyid=b.fips ;")
head(df_join1)
df_join2 <- sqldf("select * from df_join1 a left join df_filter_map_change_25_40 b on a.countyid=b.fips ;")
str(df_all_numeric)
```
...
plot_usmap(data = df_filter_map_change_100_800, values = "Change100") + scale_fill_continuous(
    low = "green", high = "magenta",
  name = "Broadband Percent Change >100", label = scales::comma) + 
  theme(legend.position = "top")
