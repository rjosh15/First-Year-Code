...
colnames(df_filter_map_change_25)[9] <- "BBD Change <25%"
colnames(df_filter_map_change_40_100)[9] <- "40<=BBD Change <=100%"
colnames(df_filter_map_change_25_40)[9] <- "25<=BBD Change <=40%"
colnames(df_filter_map_change_100_800)[9] <- "BBD Change > 100%"
...
plot_usmap(data = df_filter_map_change_100_800, values = "BBD Change > 100%") + scale_fill_continuous(
    low = "green", high = "magenta",
